...
ModMint is a standalone web app where users type a simple idea and get a generated Minecraft Forge 1.20.1 mod starter project as a downloadable `.zip`.
...
- Generates a complete mod scaffold (`mods.toml`, Java classes, Forge gradle files, README).
...
- Generated output targets Minecraft Forge 1.20.1 + Java 17 conventions.
